...
exports.dashboard = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const overview = await dashboardService.dashboard(req);
    (0, response_1.sendSuccess)(res, "Lấy dữ liệu dashboard thành công!", { overview });
});
...
exports.revenueChartPost = (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    (0, response_1.sendSuccess)(res, "Lấy dữ liệu biểu đồ thành công!", data);
});
